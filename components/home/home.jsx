        ...
        <div className="container mx-auto mt-12 px-7 md:flex md:justify-between  ">
          ...
          <div className="flex flex-col md:w-full md:mx-40">
            ...
            <div className="w-full pt-2 relative mx-auto text-gray-60 ">
              <input className="border-2 w-full border-gray-300 bg-white py-3 px-4  rounded-full text-sm focus:outline-none focus:border-red-300" type="search" name="search" placeholder="Search"/>
            ...
            <div className="flex flex-col py-5">
              {dataAntrian.map((antrian, index) => {
                return (
                  <button
                    className="flex items-center justify-between w-full py-4 px-3 mb-2 rounded-full bg-red-300 hover:bg-red-400">
                    <div className="font-reguler text-sm">{antrian.nama}</div>
                    <div className="flex justify-between items-center">
                      <div className="mx-3 font-bold items-center text-sm"> {antrian.max_antrian} </div>
                      <BsFillPeopleFill/>
                    </div>
                  </button>
                )
